...
export const services: Record<string, ServiceData> = {
  ...
  'investment-management': {
    ...
    icon: BarChart3,
    description: 'Disciplined, tax-efficient investment management built on evidence-based strategies — not market timing or product sales.',
    bulletPoints: [
      'Diversified portfolio construction and rebalancing',
      'Tax-loss harvesting and asset location strategy',
      'Employer retirement plan optimization (401k, 403b)',
      'Risk assessment aligned with your actual timeline',
    ...
    faqs: [
      {
        ...
        a: "We use an evidence-based approach grounded in diversification, low costs, and tax efficiency. We don't try to time the market or chase hot stocks. Instead, we build portfolios designed to capture market returns while managing risk appropriate to your timeline and goals.",
      },
      {
        q: 'What is tax-loss harvesting?',
        a: "Tax-loss harvesting involves selling investments at a loss to offset capital gains elsewhere in your portfolio. When done strategically, it can reduce your tax bill without meaningfully changing your portfolio's risk profile. We look for these opportunities throughout the year, not just in December.",
      },
      {
        q: 'Do you use actively managed funds or index funds?',
        a: "We primarily use low-cost index funds and ETFs, supplemented by select actively managed strategies where evidence supports their value. Our focus is on keeping your total investment costs low while maintaining appropriate diversification.",
      },
      {
        q: 'How do you determine my risk tolerance?',
        a: "We look at both your emotional comfort with market volatility and your actual financial capacity to take risk — based on your timeline, income stability, and spending needs. A good portfolio matches both dimensions, not just one.",
      },
      {
        q: 'Can you manage my 401(k) at work?',
        a: "While we can't directly manage employer-sponsored plans, we can review your plan's investment options, recommend an allocation strategy, and coordinate your 401(k) with your other accounts to ensure your overall portfolio is properly balanced and tax-efficient.",
      },
    ],
  },
  'tax-planning': {
