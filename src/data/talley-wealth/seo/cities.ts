...
export const cities: Record<string, CityData> = {
  'johnson-city': {
    ...
    state: 'TN',
    slug: 'johnson-city',
    angle: 'Home-market city with healthcare, higher-education, professional, and business-owner planning patterns',
    county: 'Washington County',
    population: '71,000+',
    employers: ['Healthcare systems', 'Higher-education institutions', 'Regional financial operations', 'Local business owners'],
    landmarks: ['Founders Park', 'Downtown Johnson City', 'Tweetsie Trail', 'Appalachian Highlands'],
    whyLocal: "Johnson City is home base for Talley Wealth. That matters because the first conversation usually does not start from a slogan. It starts from a real decision: retirement is close, the business is producing real income, or the tax and investment pieces are starting to affect each other.",
    localThesis: 'Johnson City is the home-market page: retirement transition, business-owner strategy, healthcare and higher-education planning patterns, and David-led community credibility.',
    bestFitAudience: 'Pre-retirees, retirees, business owners, healthcare professionals, higher-education families, and households whose tax, investment, and estate decisions need a real plan.',
    livedLocalProof: 'Talley Wealth is based in Johnson City, and David has built the firm around the two situations that show up most often here: retirement getting real and business success creating bigger tax and strategy decisions.',
    strategyBrief: {
      localTruth: 'Johnson City is the home market and should feel like the firm is speaking from inside its own community, not targeting a city from the outside.',
      whoThisIsReallyFor: 'People with meaningful decisions around retirement, owner income, healthcare or university benefits, inherited wealth, or family financial responsibility.',
      whatTheyAreProbablyFeeling: 'They want a capable local person who can connect the pieces without making the planning process feel like a sales performance.',
      whatNotToOverdo: 'Do not turn Johnson City into a list of employers or pretend every local person has the same healthcare or higher-education planning issue.',
      voiceNotes: 'Plain, confident, and home-market specific. The local proof can be quiet because the office and community presence already do real work.',
    },
    cityPage: {
      ...
      sectionLabel: 'Why people reach out',
      sectionTitle: 'The search may be local. The concern is usually personal.',
      sectionBody: [
      ...
      proofTitle: 'Home-market proof',
      proofBody: 'Talley Wealth is based in Johnson City and built around the two main lanes that show up again and again here: retirement transition and business-owner strategy.',
      cards: [
        { title: 'Retirement transition', body: 'For households close enough to retirement that income, taxes, investments, Medicare, Social Security, and estate decisions need to be sequenced.' },
        { title: 'Business-owner strategy', body: 'For owners whose business is working, but whose tax bill, cash flow, owner pay, and personal wealth plan need more structure.' },
        { title: 'Home-market context', body: 'The local familiarity helps the conversation move faster. The planning still has to stand on the actual numbers and decisions.' },
      ],
      decisionDepth: {
        eyebrow: 'Decision depth',
        title: 'Johnson City context helps when the question is bigger than location.',
        intro: 'The home-market advantage is not a claim that every Johnson City household has the same problem. It is that the planning conversation can get to the real issue faster.',
        items: [
          { title: 'Retirement timing', body: 'A local search often turns into a retirement-date conversation once income, taxes, healthcare, Social Security, and investment risk are put on the same page.' },
          { title: 'Owner decisions', body: 'For owners, the useful work is often deciding what the business should fund, what the household needs, and what should be coordinated with the tax professional before year-end.' },
          { title: 'Trusted handoff', body: 'When estate, tax, legal, or family decisions need outside professionals, local familiarity can make the next step more practical.' },
        ],
      },
    },
    qualityGate: {
      ...
      score: 8,
      uniqueLocalDecision: 'Home-market page connecting Johnson City searches into retirement and owner-planning paths.',
      specificFit: 'Johnson City households and owners whose tax, investment, retirement, estate, or business decisions need a connected plan.',
      specificNonFit: 'Someone looking only for a one-time investment product or a generic advisor list.',
      proofStandard: 'Uses office location, local service area, and public review themes without employer-name targeting.',
      reviewNotes: ['First-cluster hub page', 'Situation-first routing required', 'No fee-only language'],
    },
    bulletPoints: [
    ...
    localAudiencePages: {
      preRetirees: {
        slug: 'retirement-planning-johnson-city-tn',
        metaTitle: 'Retirement Planning in Johnson City, TN | Talley Wealth',
        metaDescription: 'Retirement planning in Johnson City for income, taxes, Social Security, Medicare, Roth conversions, and investment decisions.',
        eyebrow: 'Johnson City retirement planning',
        heading: 'Retirement Planning in Johnson City, TN',
        intro: 'If retirement is close enough to put a date on it, the question is bigger than whether the account balance looks good. It is how income, taxes, Social Security, Medicare, investments, and estate decisions will work once the paycheck changes or stops.',
        sectionLabel: 'Retirement decisions',
        sectionTitle: 'The closer retirement gets, the less useful vague advice becomes.',
        sectionBody: [
        ...
        proofTitle: 'Why Johnson City context helps',
        proofBody: 'David has built Talley Wealth in Johnson City around retirement-transition households that want a plan they understand and a process that connects the major decisions.',
        bulletPoints: [
        ...
        cards: [
          { title: 'Income', body: 'Turn accounts, pensions, Social Security, and cash reserves into a retirement income plan that can be followed.' },
          { title: 'Taxes', body: 'Look ahead at Roth conversions, RMDs, capital gains, and withholding before tax season makes the decisions backward-looking.' },
          { title: 'Confidence', body: 'Make the major decisions with enough analysis that retirement feels less like a guess.' },
        ],
        decisionDepth: {
          eyebrow: 'Decision depth',
          title: 'The real question is whether the retirement date survives contact with the details.',
          intro: 'A useful retirement page should not just say retirement planning is important. It should show the decisions that need sequencing before work becomes optional.',
          items: [
            { title: 'Income order', body: 'Which account gets used first can affect taxes, risk, Roth conversion windows, and how confident the household feels about spending.' },
            { title: 'Tax timing', body: 'The years before RMDs and after the paycheck changes can be some of the most important planning years.' },
            { title: 'Family readiness', body: 'Estate documents, beneficiary choices, spouse confidence, and aging-parent concerns often become part of the retirement decision.' },
          ],
        },
        faqs: [
          { q: 'When should I start serious retirement planning?', a: 'The five to ten years before retirement are usually the highest-leverage years. That is when Social Security timing, Roth conversions, Medicare, account withdrawals, and investment risk can still be shaped before the decisions become urgent.' },
          { q: 'Do I need to move my investments before getting a plan?', a: 'No. Keystone starts as a planning engagement. Whether investments should move is a decision made during the work, based on what the plan actually needs.' },
          { q: 'Can you coordinate retirement planning with my tax return?', a: 'Yes. David is both a CFP® professional and an Enrolled Agent, so retirement income and tax strategy can be reviewed in the same planning conversation.' },
        ],
        scenario: {
          title: 'A Johnson City couple trying to put a retirement date on the calendar',
          situation: 'A couple in their early 60s has several retirement accounts, Social Security decisions coming up, a taxable account, and estate documents from years ago. They are not sure which account to use first or whether Roth conversions would help.',
          approach: 'We would start by projecting retirement income, taxes, and spending under several timing scenarios. Then we would compare Social Security claiming ages, model Roth conversion windows, review the investment allocation against planned withdrawals, and flag estate or beneficiary gaps that need attention.',
        },
        ctaTitle: 'Start with the retirement decision that keeps coming back.',
        ctaDescription: 'The Explore Call is a short way to see whether Keystone is the right next step for your Johnson City retirement planning.',
        strategyBrief: {
          identity: 'Johnson City households close enough to retirement that the decisions feel real: income, taxes, Social Security, Medicare, investments, and estate documents.',
          familyLayer: 'Often a couple decision, with spouse confidence, adult children, aging parents, or old estate documents quietly affecting the urgency.',
          retirementOrExitLayer: 'The pressure is usually the retirement date, work optionality, and whether the plan still works after the paycheck changes.',
          voiceNotes: 'Treat retirement as a practical decision that deserves serious modeling, not as a lifestyle slogan.',
        },
        qualityGate: {
          approvedForIndex: true,
          score: 8,
          uniqueLocalDecision: 'Johnson City retirement page focused on retirement-date, income, tax, and estate sequencing.',
          specificFit: 'Johnson City households close enough to retirement that timing, income, taxes, Medicare, Social Security, and investments need one plan.',
          specificNonFit: 'Someone who only wants a retirement calculator or account-only allocation review.',
          proofStandard: 'Uses local office/service-area context and planning-specific proof, not employer-name targeting.',
          reviewNotes: ['First-cluster local retirement page', 'Requires real retirement sequencing detail', 'No fee-only language'],
        },
      },
      businessOwners: {
        slug: 'financial-planning-for-johnson-city-business-owners',
        metaTitle: 'Financial Planning for Johnson City Business Owners | Talley Wealth',
        metaDescription: 'Financial planning for Johnson City business owners coordinating taxes, owner pay, retirement plans, cash flow, and personal wealth.',
        eyebrow: 'Johnson City business-owner planning',
        heading: 'Financial Planning for Johnson City Business Owners',
        intro: 'A Johnson City business owner usually reaches out after the business has started working well enough to create new pressure. The tax bill is bigger, cash decisions matter more, and the owner may be carrying too many financial decisions alone.',
        sectionLabel: 'Owner decisions',
        sectionTitle: 'The business and the personal plan are already connected.',
        sectionBody: [
        ...
        proofTitle: 'Built for the owner conversation',
        proofBody: 'Business-owner strategy is one of Talley Wealth’s two primary planning lanes, especially when taxes start the conversation but the real need is broader.',
        bulletPoints: [
        ...
        cards: [
          { title: 'Tax pressure', body: 'The tax bill may be what gets your attention. The work should still look wider than the return.' },
          { title: 'Owner cash flow', body: 'Business reserves, payroll, household spending, retirement contributions, and estimated taxes need a rhythm.' },
          { title: 'Personal wealth', body: 'A profitable business should help build wealth outside the company, not leave the whole family plan tied to one asset.' },
        ],
        decisionDepth: {
          eyebrow: 'Decision depth',
          title: 'The owner plan has to respect both the business and the household.',
          intro: 'The useful work is not a list of tax ideas. It is deciding which owner decisions deserve structure now.',
          items: [
            { title: 'Owner pay', body: 'Salary, distributions, retirement contributions, and estimated taxes should be reviewed together instead of improvised separately.' },
            { title: 'Business cash', body: 'Reserves, payroll, equipment, growth, tax payments, and household withdrawals all compete for the same dollars.' },
            { title: 'Wealth outside the company', body: 'A good business can still leave the family overconcentrated if personal investments, insurance, estate documents, and exit options are ignored.' },
          ],
        },
        faqs: [
          { q: 'Can you help me decide whether an S-Corp makes sense?', a: 'Yes. The decision depends on profit, reasonable compensation, payroll complexity, and how the business actually runs. We model the potential savings and tradeoffs rather than treating the S-Corp as an automatic answer.' },
          { q: 'Do you replace my CPA?', a: 'Usually no. We often coordinate with the CPA and focus on forward-looking planning, tax strategy, owner decisions, and how the business affects the household plan. Tax preparation may be part of the relationship when it fits.' },
          { q: 'What if I am not trying to sell the business?', a: 'That is fine. Exit planning is only one part of owner planning. Many owners need help with current tax strategy, retirement plans, cash flow, and building personal wealth outside the business.' },
        ],
        scenario: {
          title: 'A profitable Johnson City owner whose tax bill finally got their attention',
          situation: 'The business is past survival mode. Revenue and profit are up, employees are on payroll, and the owner is writing larger tax checks. They suspect there are better strategies available, but they are not sure which ones actually fit.',
          approach: 'We would review the business tax picture, owner compensation, retirement plan options, entity structure, business cash reserves, estimated taxes, and the personal balance sheet. Then we would identify the few moves worth making and coordinate with the CPA or attorney where needed.',
        },
        ctaTitle: 'Bring the owner decision that is already taking up space.',
        ctaDescription: 'The Explore Call is a short way to talk through what is happening in the business and whether Keystone Owner is the right fit.',
        strategyBrief: {
          identity: 'Owner whose business is past survival mode and whose financial life now depends on decisions that cross the company and household.',
          businessStage: 'Profitable enough for taxes, payroll, retirement plan design, reserves, and personal wealth to matter more than they did early on.',
          taxPressure: 'The tax bill is often the first visible pain, but it is a signal to review owner compensation, entity structure, estimates, and forward-looking planning.',
          cashFlowReality: 'Profit and cash do not always feel the same once payroll, reserves, estimated taxes, household spending, and retirement contributions compete.',
          familyLayer: 'The spouse or family may feel the uncertainty even when the owner is used to carrying the decisions.',
          controlTension: 'They want help without feeling talked down to or like they are losing control of what they built.',
          retirementOrExitLayer: 'Exit may matter eventually, but many owners need current-year structure long before a sale is realistic.',
          voiceNotes: 'Speak to the owner as a capable builder who needs a better financial operating rhythm, not as someone who simply needs tax tips.',
        },
        qualityGate: {
          approvedForIndex: true,
          score: 8,
          uniqueLocalDecision: 'Johnson City owner page focused on owner pay, business cash flow, tax timing, and personal wealth outside the company.',
          specificFit: 'Owners whose business has grown enough that taxes, reserves, household income, retirement plans, and long-term wealth need more structure.',
          specificNonFit: 'Owners looking only for bookkeeping, payroll administration, or a single tax tactic.',
          proofStandard: 'Uses owner-archetype depth and local service context without employer-name claims.',
          reviewNotes: ['First-cluster business-owner page', 'Must speak to owner identity and family/business overlap', 'No fee-only language'],
        },
      },
    },
    faqs: [
      ...
      },
      {
        ...
        a: "Talley Wealth is an independent planning firm built around coordinating your financial plan, investment decisions, and tax return. We are required to act in your best interest, and we explain pricing and compensation clearly before you decide whether to move forward.",
      },
      {
      ...
      },
      {
        ...
        a: "Our planning fees depend on the complexity of your situation. Keystone is quoted as a flat planning fee, and any ongoing advisory fee is explained before you decide whether to continue. You can schedule an Explore Call to discuss fit before making any commitment.",
      },
    ],
    scenario: {
  ...
  'tri-cities': {
    ...
    whyLocal: "People around the Tri-Cities usually reach out because a specific money question has started to feel too important to keep handling casually. Retirement is getting close. A business is producing real income. A tax, investment, benefit, or estate decision needs more thought than a quick answer. Talley Wealth is based in Johnson City and serves families and business owners across the region.",
    localThesis: 'Regional authority page for the Tri-Cities that confirms local relevance and routes visitors into the stronger Johnson City, Bristol, Kingsport, retirement, and business-owner pages.',
    bestFitAudience: 'Households across the Tri-Cities who fit the main Talley Wealth lanes: pre-retirees/retirees and business owners, plus specific situations already represented in the main Who We Help architecture.',
    livedLocalProof: 'Talley Wealth is based in Johnson City and serves the broader Tri-Cities through a local, founder-led planning process.',
    strategyBrief: {
      localTruth: 'The Tri-Cities page is a regional orientation page. It should help people sort themselves into the strongest next page, not pretend the whole region has one identical financial personality.',
      whoThisIsReallyFor: 'People across Johnson City, Bristol, Kingsport, and nearby communities who are searching locally but whose real issue is retirement, owner complexity, or another specific planning decision.',
      whatTheyAreProbablyFeeling: 'They want to know whether Talley Wealth is close enough, relevant enough, and specific enough to understand the decision they are carrying.',
      whatNotToOverdo: 'Do not make visitors choose between audience and city as if those are mutually exclusive. Do not make every regional detail equally important.',
      voiceNotes: 'Use the Tri-Cities page as a sorting hub: situation first, local context second, no clever SEO lines.',
    },
    cityPage: {
      heading: 'Financial Advisor for the Tri-Cities, TN',
      intro: "Around the Tri-Cities, people usually reach out when a specific money question has started to feel too important to keep handling casually. Retirement is getting close. The business is producing real income. A tax, investment, benefit, or estate decision needs more thought than a quick answer.",
      sectionLabel: 'Why people reach out',
      sectionTitle: 'The regional page should help you choose the next right page.',
      sectionBody: [
        'If you are searching regionally, location is probably only part of the question. You may be near retirement in Bristol, running a business in Kingsport, or trying to make sense of several decisions at once in Johnson City.',
        'The deeper work still happens through the same core planning process. This page should orient you, then send you toward the situation that best explains the decision in front of you.',
      ],
      proofTitle: 'Regional context',
      proofBody: 'Talley Wealth is based in Johnson City and works with families and business owners across the Tri-Cities through a mix of local and virtual planning conversations.',
      cards: [
        { title: 'Johnson City', body: 'Home base for Talley Wealth and the primary local page for retirement-transition and business-owner planning.' },
        { title: 'Bristol', body: 'A useful starting point for Bristol and SWVA families, especially where roots, business ownership, or the TN/VA line matter.' },
        { title: 'Kingsport', body: 'A local page for Kingsport families and professionals, especially where long careers, retirement timing, or owner decisions are in view.' },
      ],
      decisionDepth: {
        eyebrow: 'Decision depth',
        title: 'The regional page works when it helps you choose, not when it tries to say everything.',
        intro: 'The Tri-Cities page should answer the regional search and then get out of the way. The next best page depends on the decision creating pressure.',
        items: [
          { title: 'If retirement is driving the search', body: 'Use the retirement path when the real question is timing, income, taxes, healthcare, Social Security, or work optionality.' },
          { title: 'If the business is driving the search', body: 'Use the owner path when the company, tax return, cash flow, retirement plan, or exit question is shaping the household plan.' },
          { title: 'If location is the filter', body: 'Use Johnson City, Bristol, or Kingsport when the local context itself changes the first conversation.' },
        ],
      },
    },
    qualityGate: {
      approvedForIndex: true,
      score: 8,
      uniqueLocalDecision: 'Regional hub that routes Tri-Cities searches into situation-first and city-specific pages.',
      specificFit: 'Tri-Cities households and owners searching regionally but needing retirement, business-owner, tax, investment, or estate decisions organized.',
      specificNonFit: 'Someone who needs a hyper-specific local answer that belongs on a city or audience page.',
      proofStandard: 'Uses service-area facts, office location, and public review themes without employer-name targeting.',
      reviewNotes: ['First-cluster regional hub', 'Must preserve situation-first routing', 'No fee-only language'],
    },
    bulletPoints: [
    ...
    faqs: [
      ...
      {
        q: 'Why work with a local planning firm?',
        a: 'Some planning can happen anywhere. But employer benefits, state tax rules, family business decisions, and trusted local professionals often make the first conversation easier when the advisor understands the Tri-Cities.',
      },
      {
    ...
    scenario: {
      ...
      situation: "A couple in their early 60s lives near Johnson City, has retirement accounts from multiple employers, a CPA who prepares the return, and estate documents that have not been revisited in years. Nothing is obviously broken, but the next few decisions feel too important to keep handling separately.",
      approach: "We might start by mapping the full household balance sheet, then build retirement income and tax projections around Social Security timing, Roth conversion windows, account withdrawals, and estate liquidity. From there, we would coordinate with their CPA and attorney where needed so the work turns into decisions instead of a thicker file.",
    },
  },
  'kingsport': {
    name: 'Kingsport',
    state: 'TN',
    slug: 'kingsport',
    angle: 'Manufacturing and major-employer economy with long-career households',
    county: 'Sullivan County',
    population: '54,000+',
    employers: ['Large regional manufacturers', 'Healthcare employers', 'Industrial employers', 'Local professional firms'],
    landmarks: ['Bays Mountain Park', 'MeadowView Conference Center', 'Downtown Kingsport', 'Major regional employer campuses'],
    whyLocal: "Kingsport planning often starts with long careers, valuable benefits, pension-style decisions, stock or deferred compensation, and practical families who want the math to make sense before they make a move. People are usually trying to answer a plain question: can I retire, what should I do with this election, how will taxes work, or is the investment account matched to the life I am actually building?",
    localThesis: 'Kingsport pages should speak to long-career professionals, major-employer culture, pension/benefit complexity, engineers, analytical families, and salt-of-the-earth households.',
    bestFitAudience: 'Pre-retirees and business owners in Kingsport, especially households with employer benefits, pension-style decisions, deferred compensation, stock, or manufacturing/economic ties.',
    livedLocalProof: 'Talley Wealth serves Kingsport as part of the Tri-Cities, with local planning context around employer benefits, retirement timing, and business-owner tax strategy.',
    strategyBrief: {
      localTruth: 'Kingsport should feel practical and benefit-aware: long careers, employer-shaped wealth, analytical families, and owners who want the math to make sense.',
      whoThisIsReallyFor: 'Long-career professionals, practical retirees, technical/engineering households, and owners whose business or employer benefits create real planning decisions.',
      whatTheyAreProbablyFeeling: 'They may not want flash. They want clear math, respect for what they built, and a decision they can explain.',
      whatNotToOverdo: 'Do not imply unverified employer-specific benefit expertise or make every Kingsport household a major-employer household.',
      voiceNotes: 'Plain and specific. Use employer context as a clue to the planning issue, not as decoration.',
    },
    cityPage: {
      intro: "Kingsport families often bring a practical kind of planning question. It may be a retirement date, a benefit election, deferred compensation, a business tax issue, or the simple feeling that the numbers need to be modeled before a major step gets taken.",
      sectionLabel: 'Why people reach out',
      sectionTitle: 'The useful work is often in the details.',
      sectionBody: [
        ...
        'This page should help you choose the right doorway. If retirement timing or benefits are the pressure, the retirement page should go deeper. If the business is creating the pressure, the owner page is the better next step.',
      ],
      proofTitle: 'Kingsport planning context',
      proofBody: 'Talley Wealth works with Kingsport families and professionals who need employer benefits, retirement timing, taxes, investments, and personal decisions reviewed together.',
      cards: [
        { title: 'Long-career decisions', body: 'Pension-style income, stock, deferred compensation, and 401(k) choices can materially change the retirement plan.' },
        { title: 'Retirement timing', body: 'The right retirement date depends on income, taxes, healthcare, portfolio withdrawals, and spouse or family goals.' },
        { title: 'Business-owner tax pressure', body: 'Kingsport owners often need owner pay, tax strategy, retirement plans, and personal wealth coordinated.' },
      ],
      decisionDepth: {
        eyebrow: 'Decision depth',
        title: 'Kingsport planning often turns on long-career and practical owner decisions.',
        intro: 'The local pattern is not about naming a specific employer. It is about the way benefits, technical careers, business ownership, and practical family decisions can shape the plan.',
        items: [
          { title: 'Benefit-shaped wealth', body: 'Long careers can create pension-style income, deferred compensation, company stock, or other benefit decisions that need careful modeling.' },
          { title: 'Plain-English math', body: 'Many Kingsport families want a decision they can understand and explain, not a glossy presentation.' },
          { title: 'Owner pressure', body: 'For owners, the questions usually come back to tax timing, owner pay, retirement contributions, reserves, and building wealth outside the company.' },
        ],
      },
    },
    qualityGate: {
    ...
    heroImage: '/brands/talley-wealth/cities/kingsport-bays-mountain.webp',
    heroImageAlt: 'Aerial view of Kingsport, Tennessee with regional industry and surrounding hills',
    enabledServices: ['retirement-planning', 'tax-planning'],
    localAudiencePages: {
      preRetirees: {
        slug: 'retirement-planning-kingsport-tn',
        metaTitle: 'Retirement Planning in Kingsport, TN | Talley Wealth',
        metaDescription: 'Retirement planning in Kingsport for employer benefits, pensions, deferred compensation, Social Security, taxes, and investments.',
        eyebrow: 'Kingsport retirement planning',
        heading: 'Retirement Planning in Kingsport, TN',
        intro: 'If you have built a long career in Kingsport, retirement can involve more than a 401(k) balance. Benefit elections, deferred compensation, employer stock, Social Security, taxes, healthcare, and investment withdrawals may all need to be modeled before you choose a date.',
        sectionLabel: 'Retirement decisions',
        sectionTitle: 'Employer benefits can be valuable and complicated at the same time.',
        sectionBody: [
        ...
        proofTitle: 'Why Kingsport context helps',
        proofBody: 'Kingsport has a long history of employer-shaped wealth. The planning has to respect benefits, pension-style choices, stock, deferred compensation, and practical decision-making.',
        bulletPoints: [
        ...
        cards: [
          { title: 'Benefit elections', body: 'Model pension-style choices, deferred comp, stock, and 401(k) decisions before they become hard to change.' },
          { title: 'Tax timing', body: 'Use the retirement transition years intentionally instead of letting RMDs and income surprises drive the plan later.' },
          { title: 'Plain-English math', body: 'The goal is a decision you understand well enough to act on.' },
        ],
        decisionDepth: {
          eyebrow: 'Decision depth',
          title: 'Benefit decisions need to be modeled before they become permanent.',
          intro: 'For many long-career households, the retirement question is less about one account balance and more about how several decisions fit together.',
          items: [
            { title: 'Election timing', body: 'Pension-style choices, deferred compensation, stock, or rollover decisions can affect taxes, income, survivor planning, and portfolio risk.' },
            { title: 'Healthcare bridge', body: 'A retirement date before Medicare can make healthcare costs and spouse coverage part of the financial decision.' },
            { title: 'Tax windows', body: 'The transition years may create opportunities for Roth conversions, tax-bracket management, or withdrawal-order planning.' },
          ],
        },
        faqs: [
          { q: 'Can you help with pension or lump-sum decisions?', a: 'Yes. We can compare pension-style options against the rest of the plan, including spouse benefits, taxes, life expectancy assumptions, investment risk, and cash-flow needs.' },
          { q: 'What if I have deferred compensation or company stock?', a: 'Those decisions should be modeled with your tax bracket, retirement date, portfolio risk, and cash-flow needs. We can compare timing scenarios before you act.' },
          { q: 'Do I need to work for a major Kingsport employer to work with you?', a: 'No. We work with Kingsport families across employers and businesses. The common thread is that the retirement decisions need more than a quick account review.' },
        ],
        scenario: {
          title: 'A Kingsport professional trying to retire without making the wrong election',
          situation: 'A long-tenured Kingsport professional is thinking about retiring in the next few years. They have a 401(k), possible pension-style income, deferred compensation, and a spouse whose own retirement timing affects the plan.',
          approach: 'We would compare retirement dates, model income and taxes, evaluate any pension-style election, coordinate deferred compensation timing, and build a withdrawal strategy that shows which accounts to use and when.',
        },
        ctaTitle: 'Before you make the retirement election, model the whole picture.',
        ctaDescription: 'The Explore Call is a short way to see whether Keystone fits your Kingsport retirement decisions.',
        strategyBrief: {
          identity: 'Kingsport household with a long career, meaningful benefits, and a retirement decision that should be modeled before it becomes final.',
          familyLayer: 'Spouse timing, survivor income, healthcare, and family expectations often matter as much as the employee benefit decision.',
          retirementOrExitLayer: 'The retirement date, benefit elections, deferred compensation, stock, and Social Security timing are the pressure points.',
          voiceNotes: 'Respect the practical, analytical mindset. Make the promise clearer math and better sequencing, not excitement about retirement.',
        },
        qualityGate: {
          approvedForIndex: true,
          score: 8,
          uniqueLocalDecision: 'Kingsport retirement page focused on long-career benefits, retirement timing, healthcare bridge, and tax windows.',
          specificFit: 'Kingsport families whose retirement decisions include benefit elections, deferred compensation, stock, spouse timing, taxes, or withdrawal sequencing.',
          specificNonFit: 'Someone seeking employer-specific plan administration or a generic account rollover pitch.',
          proofStandard: 'Uses broad long-career and benefit-complexity patterns without naming employers or implying affiliation.',
          reviewNotes: ['First-cluster local retirement page', 'No direct employer-name targeting', 'No fee-only language'],
        },
      },
      businessOwners: {
        slug: 'financial-planning-for-kingsport-business-owners',
        metaTitle: 'Financial Planning for Kingsport Business Owners | Talley Wealth',
        metaDescription: 'Planning for Kingsport business owners around taxes, owner pay, retirement plans, cash flow, investments, and personal wealth.',
        eyebrow: 'Kingsport business-owner planning',
        heading: 'Financial Planning for Kingsport Business Owners',
        intro: 'A Kingsport business owner may start with one question: Why is the tax bill so high? Should I be an S-Corp? How much should I pay myself? Usually the owner is not looking for a trick. They want the business, household, and tax picture to make more sense.',
        sectionLabel: 'Owner decisions',
        sectionTitle: 'The business may be working. The owner plan still needs structure.',
        sectionBody: [
        ...
        proofTitle: 'Owner planning that goes wider than one tax idea',
        proofBody: 'Business-owner strategy is a primary Talley Wealth lane because owner taxes, cash flow, investments, retirement, and exit questions rarely stay separate.',
        bulletPoints: [
        ...
        cards: [
          { title: 'Tax strategy', body: 'Sort through which tax strategies actually fit the business instead of chasing every idea.' },
          { title: 'Owner compensation', body: 'Make owner pay, distributions, taxes, and household cash flow less improvised.' },
          { title: 'Wealth outside the business', body: 'Build a plan that does not depend entirely on selling the company someday.' },
        ],
        decisionDepth: {
          eyebrow: 'Decision depth',
          title: 'A practical owner needs structure that fits how the business actually works.',
          intro: 'The planning should make the next few owner decisions clearer without turning the business into a spreadsheet exercise.',
          items: [
            { title: 'Cash rhythm', body: 'Uneven cash flow, reserves, taxes, owner pay, and retirement contributions need a rhythm the owner can actually follow.' },
            { title: 'Household reliance', body: 'The business may fund the family today, but the plan should also build options outside the company.' },
            { title: 'Professional coordination', body: 'The best next step may involve the CPA, payroll provider, attorney, or insurance professional once the owner strategy is clear.' },
          ],
        },
        faqs: [
          { q: 'Can you help determine reasonable compensation?', a: 'Yes. For S-Corp owners, reasonable compensation has to be grounded in the actual role, business economics, and tax rules. We help model the tradeoff and coordinate with payroll, CPA, or attorney as needed.' },
          { q: 'What if my business is profitable but cash flow is uneven?', a: 'That is common. Planning should account for seasonality, reserves, estimated taxes, household spending, and retirement contributions so good profit does not still feel financially chaotic.' },
          { q: 'Do you only work with large businesses?', a: 'No. The fit depends less on size and more on whether the business creates meaningful tax, cash-flow, retirement, or personal wealth decisions.' },
        ],
        scenario: {
          title: 'A Kingsport owner trying to stop guessing on tax and owner pay',
          situation: 'The business is profitable, but the owner is unsure whether salary, distributions, retirement contributions, and estimated taxes are being handled in the smartest way. They also want to build wealth outside the business without starving operations.',
          approach: 'We would review the tax return, entity setup, owner pay, cash reserves, retirement plan options, household spending, and investment accounts. Then we would create a practical owner strategy and coordinate the implementation pieces with the right professionals.',
        },
        ctaTitle: 'Bring the owner decision that feels too important to keep guessing on.',
        ctaDescription: 'The Explore Call is a short way to see whether Keystone Owner fits your Kingsport business and household planning.',
        strategyBrief: {
          identity: 'Practical Kingsport owner whose business is successful enough that tax, cash, owner pay, and household wealth need more structure.',
          businessStage: 'Established enough to have real profit, payroll or contractors, uneven cash needs, and questions about how much should stay in the business.',
          taxPressure: 'Tax pain may start the conversation, but the work should move quickly into compensation, retirement contributions, estimates, and entity fit.',
          cashFlowReality: 'The owner may show profit and still feel cash tension because business reserves, family spending, taxes, and investment goals compete.',
          familyLayer: 'The household often feels the business risk even when only one person owns or operates the company.',
          controlTension: 'They want practical advice that respects their judgment and does not turn the business into an abstraction.',
          retirementOrExitLayer: 'Some need exit planning; many simply need to stop making current owner decisions by guesswork.',
          voiceNotes: 'Talk like an advisor sitting across from a capable local owner: specific, steady, and useful.',
        },
        qualityGate: {
          approvedForIndex: true,
          score: 8,
          uniqueLocalDecision: 'Kingsport owner page focused on practical cash rhythm, tax timing, household reliance, and wealth outside the business.',
          specificFit: 'Kingsport owners with meaningful tax, cash-flow, retirement-plan, owner-pay, or family-wealth decisions.',
          specificNonFit: 'Owners looking only for bookkeeping, payroll administration, or employer-specific benefits content.',
          proofStandard: 'Uses owner-pattern depth and service-area context without employer-name targeting.',
          reviewNotes: ['First-cluster business-owner page', 'No direct employer-name targeting', 'No fee-only language'],
        },
      },
    },
    serviceOverrides: {
  ...
  'bristol': {
    ...
    county: 'Sullivan County',
    population: '27,000+',
    employers: ['Regional healthcare employers', 'Hospitality and entertainment employers', 'Energy and natural-resource employers', 'Local colleges and professional firms'],
    landmarks: ['State Street (TN/VA line)', 'Downtown Bristol', 'Regional entertainment venues', 'Appalachian Highlands communities'],
    whyLocal: "Bristol is one of the places where local context can actually change the planning conversation. The state line is real from a tax standpoint, but the page should not reduce Bristol to a tax gimmick. The better story is roots, SWVA/Appalachian families, independent business owners, retirees, and people who want careful advice without feeling talked down to or sold to.",
    localThesis: 'Bristol is the voice prototype: David’s roots, SWVA/Appalachian identity, independent families, millionaires-next-door, business owners, retirees, and TN/VA tax reality.',
    bestFitAudience: 'Bristol and SWVA families near retirement, independent business owners, cross-border households, and people with meaningful money who prefer practical local trust over polished national-firm language.',
    livedLocalProof: 'David has personal roots in Bristol and understands the kind of quiet, independent wealth and cross-border complexity that can show up around the TN/VA line.',
    strategyBrief: {
      localTruth: 'Bristol has real local texture: David roots, TN/VA state-line facts, SWVA/Appalachian identity, independent families, and quiet wealth.',
      whoThisIsReallyFor: 'Retirees, near-retirees, cross-border households, independent owners, and millionaire-next-door families who want careful advice without being talked down to.',
      whatTheyAreProbablyFeeling: 'They may have done a lot right on their own and now want someone practical to help sort through decisions that are getting bigger.',
      whatNotToOverdo: 'Do not reduce Bristol to a tax gimmick, Appalachian stereotype, or clever state-line joke.',
      voiceNotes: 'Bristol should be the voice prototype: plain, respectful, rooted, and allergic to manufactured local color.',
    },
    cityPage: {
      intro: "Bristol is a little different financially because the state line can affect more than the mailing address. If you live on one side, work on the other, own a business, have property, or are thinking about retirement, the Tennessee/Virginia split can affect real decisions.",
      sectionLabel: 'Why people reach out',
      sectionTitle: 'The local details matter when they change the decision.',
      sectionBody: [
        'The state line matters when it changes the numbers. It does not need to be the whole story. The bigger question is usually whether retirement, business income, investments, taxes, and family decisions are being looked at together.',
        'The local page should help you decide where to go next. If retirement is the main question, start with the Bristol retirement page. If the business is driving the complexity, start with the Bristol owner page. If both are true, start with whichever decision needs attention first.',
      ],
      proofTitle: 'Bristol context',
      proofBody: 'For Bristol, local proof means understanding the TN/VA tax reality and the kind of practical, independent families who live around it.',
      cards: [
        { title: 'TN/VA tax reality', body: 'State residency, work location, retirement income, business income, and property can all make the line matter.' },
        { title: 'Retirement decisions', body: 'Bristol families often need income, Social Security, Roth conversions, taxes, investments, and estate details organized before retirement.' },
        { title: 'Business-owner pressure', body: 'Independent owners may need tax strategy, owner pay, cash reserves, retirement plans, and personal investments handled together.' },
      ],
      decisionDepth: {
        eyebrow: 'Decision depth',
        title: 'Bristol is strongest when the page treats the state line as a decision, not a gimmick.',
        intro: 'The local value is not repeating TN/VA in every paragraph. It is knowing when that line changes retirement, business, property, or family decisions.',
        items: [
          { title: 'Residency and sourcing', body: 'Where someone lives, works, owns property, or earns business income can change the tax conversation.' },
          { title: 'Roots and tradeoffs', body: 'The numbers matter, but family roots, house, community, and spouse preferences can be just as real.' },
          { title: 'Independent wealth', body: 'Some Bristol households have built meaningful wealth quietly and want careful advice without feeling talked down to.' },
        ],
      },
    },
    qualityGate: {
      approvedForIndex: true,
      score: 8,
      uniqueLocalDecision: 'Bristol page focused on TN/VA state-line decisions, roots, independent families, retirement, and owner planning.',
      specificFit: 'Bristol and SWVA households or owners where residency, taxes, retirement timing, business income, or family roots affect the plan.',
      specificNonFit: 'Someone looking for a generic city page or a tax-only answer that ignores life tradeoffs.',
      proofStandard: 'Uses state-line facts, service area, David roots, and public review themes without named-employer targeting.',
      reviewNotes: ['First-cluster hub page', 'State line should not become a gimmick', 'No fee-only language'],
    },
    bulletPoints: [
      'Cross-state tax planning for TN/VA residents',
      'Virginia income tax strategies for Bristol VA families',
      'Retirement planning for hospitality and regional entertainment professionals',
      'Investment management with a fiduciary standard',
    ...
    localAudiencePages: {
      preRetirees: {
        slug: 'retirement-planning-bristol-tn-va',
        metaTitle: 'Retirement Planning in Bristol, TN/VA | Talley Wealth',
        metaDescription: 'Retirement planning for Bristol TN and VA families coordinating income, taxes, Social Security, Roth conversions, investments, and residency questions.',
        eyebrow: 'Bristol retirement planning',
        heading: 'Retirement Planning in Bristol, TN/VA',
        intro: 'If you are within a few years of retirement in Bristol, the question is usually bigger than whether you have enough saved. It is how income, taxes, Social Security, Medicare, investments, and the Tennessee/Virginia line will work once paychecks stop.',
        sectionLabel: 'Retirement decisions',
        sectionTitle: 'Around Bristol, retirement planning can cross the state line.',
        sectionBody: [
        ...
        proofTitle: 'Why Bristol context matters',
        proofBody: 'Bristol retirement planning should understand both the cross-border tax facts and the real-life reasons families may or may not want to move across State Street.',
        bulletPoints: [
        ...
        cards: [
          { title: 'Income', body: 'Turn accounts, pensions, Social Security, and cash reserves into a withdrawal plan.' },
          { title: 'Residency', body: 'Compare the tax impact of Tennessee and Virginia without pretending taxes are the only factor.' },
          { title: 'Timing', body: 'Use the retirement transition years intentionally for Roth conversions, withdrawals, and tax planning.' },
        ],
        decisionDepth: {
          eyebrow: 'Decision depth',
          title: 'The state-line question only matters if it changes the retirement decision.',
          intro: 'A stronger Bristol retirement page should help people compare the numbers without pretending the decision is only financial.',
          items: [
            { title: 'Income mix', body: 'IRA withdrawals, pensions, Social Security, taxable accounts, and business or rental income may each interact with state residency differently.' },
            { title: 'Move or stay', body: 'The planning should put tax savings beside the real-life tradeoffs: home, spouse preference, family roots, healthcare, and timing.' },
            { title: 'Transition years', body: 'Roth conversions, account order, Medicare timing, and withholding decisions often need attention before the first full retirement year.' },
          ],
        },
        faqs: [
          { q: 'Should I retire in Bristol TN or Bristol VA?', a: 'It depends on your income sources, housing preferences, family situation, and tax picture. Tennessee has no state income tax, while Virginia may tax certain retirement income. We model the actual difference before treating a move as the obvious answer.' },
          { q: 'Does the TN/VA line matter if I am already retired?', a: 'It can. IRA withdrawals, pension income, taxable investments, rental property, and business income may be treated differently depending on residency and sourcing. The impact depends on your actual facts.' },
          { q: 'Can you help if my spouse and I disagree about moving?', a: 'Yes. The planning should put numbers around the tradeoff without pretending the decision is only financial. Family roots, house, community, healthcare, and taxes all matter.' },
        ],
        scenario: {
          title: 'A Bristol family deciding whether the state line matters enough to move',
          situation: 'A couple in their early 60s lives in Bristol, VA and is close to retirement. They have IRA assets, taxable investments, Social Security decisions, and family roots nearby. They wonder whether moving to Bristol, TN would materially improve the plan.',
          approach: 'We would project retirement income and taxes under both residency scenarios, compare the cumulative impact, model Roth conversion opportunities, and then put the tax savings beside the real-life tradeoffs: home, family, community, and timing.',
        },
        ctaTitle: 'Bring the Bristol retirement question that keeps coming back.',
        ctaDescription: 'The Explore Call is a short way to see whether Keystone is the right fit for your Bristol retirement planning.',
        strategyBrief: {
          identity: 'Bristol or SWVA household close to retirement, often independent and practical, with enough saved that the next decisions deserve more structure.',
          familyLayer: 'Family roots, house, community, spouse preferences, and adult children can matter as much as the state tax math.',
          retirementOrExitLayer: 'The pressure is usually retirement timing, account order, Social Security, Medicare, Roth conversions, and whether the TN/VA line changes the plan.',
          voiceNotes: 'Do not make the page sound like the answer is always to move. Model the numbers and respect the life tradeoffs.',
        },
        qualityGate: {
          approvedForIndex: true,
          score: 8,
          uniqueLocalDecision: 'Bristol retirement page focused on TN/VA residency, retirement income taxation, family roots, and transition-year decisions.',
          specificFit: 'Bristol and SWVA households close to retirement where income order, residency, taxes, Social Security, Medicare, and Roth conversions need sequencing.',
          specificNonFit: 'Someone looking for a blanket answer that moving across the line is always right.',
          proofStandard: 'Uses state-line planning facts and David/local roots without named-employer targeting or invented testimonials.',
          reviewNotes: ['First-cluster local retirement page', 'State line should be modeled, not hyped', 'No fee-only language'],
        },
      },
      businessOwners: {
        slug: 'financial-planning-for-bristol-business-owners',
        metaTitle: 'Financial Planning for Bristol Business Owners | Talley Wealth',
        metaDescription: 'Planning for Bristol business owners around tax strategy, owner pay, TN/VA income questions, retirement plans, cash flow, and personal wealth.',
        eyebrow: 'Bristol business-owner planning',
        heading: 'Financial Planning for Bristol Business Owners',
        intro: 'A successful Bristol business can create a strange kind of pressure. The business is working, but the owner may still be guessing on tax payments, cash reserves, owner pay, retirement contributions, and how much wealth should live outside the company.',
        sectionLabel: 'Owner decisions',
        sectionTitle: 'For Bristol owners, the business question can cross into the household plan quickly.',
        sectionBody: [
        ...
        proofTitle: 'Bristol owner context',
        proofBody: 'Bristol has plenty of quiet, independent business owners who need tax-aware advice that respects how they actually built the business.',
        bulletPoints: [
          'Owner compensation, distributions, and estimated taxes',
        ...
        cards: [
          { title: 'Tax pressure', body: 'Use the tax bill as a starting signal, then review the wider owner picture.' },
          { title: 'Cross-border facts', body: 'Look at Tennessee and Virginia sourcing or residency questions when they actually apply.' },
          { title: 'Owner wealth', body: 'Turn business success into household wealth without starving the company of the cash it needs.' },
        ],
        decisionDepth: {
          eyebrow: 'Decision depth',
          title: 'Bristol owner planning should stay practical and rooted.',
          intro: 'The local angle helps when it changes sourcing, residency, cash-flow, or household decisions. It should not turn the owner page into a tax gimmick.',
          items: [
            { title: 'Business and household cash', body: 'The owner needs enough cash in the company and enough clarity at home for taxes, reserves, payroll, retirement contributions, and family goals.' },
            { title: 'State-line facts', body: 'Where the business operates, where income is sourced, and where the owner lives can matter, but only after the actual facts are reviewed.' },
            { title: 'Respect for the builder', body: 'Many independent owners want someone who can think with them plainly without dismissing the judgment that built the business.' },
          ],
        },
        faqs: [
          { q: 'Does it matter if my Bristol business has income on both sides of the state line?', a: 'It can. The answer depends on where the business is located, where services are performed, where clients are, and how the entity is structured. We review the facts and coordinate with tax professionals where needed.' },
          { q: 'Can you help me decide how much to pay myself?', a: 'Yes. Owner pay should account for reasonable compensation rules, payroll taxes, household needs, retirement contributions, business reserves, and estimated taxes.' },
          { q: 'What if I am not trying to sell the business?', a: 'That is common. Many owners need current-year tax strategy, retirement plan design, cash-flow structure, and personal wealth planning long before exit planning becomes urgent.' },
        ],
        scenario: {
          title: 'A Bristol owner whose tax bill started to feel like the business plan',
          situation: 'A Bristol business owner has strong profit, uneven cash flow, and clients or operations that touch both Tennessee and Virginia. They are unsure whether owner pay, entity structure, retirement contributions, and estimated taxes are being handled intentionally.',
          approach: 'We would review the tax return, entity structure, owner compensation, business reserves, household spending, retirement plan options, and any TN/VA sourcing issues. Then we would build a short list of practical moves and coordinate the pieces that need CPA or attorney input.',
        },
        ctaTitle: 'Bring the business question. We will make it practical.',
        ctaDescription: 'The Explore Call is a short way to see whether Keystone Owner fits your Bristol business and household planning.',
        strategyBrief: {
          identity: 'Independent Bristol or SWVA owner who has built something real and wants advice that respects the work behind it.',
          businessStage: 'Past the earliest survival phase, with profit, tax questions, household reliance, and maybe employees or contractors depending on the business.',
          taxPressure: 'The tax bill may be painful, and the TN/VA line may matter, but the plan should not become a tax gimmick.',
          cashFlowReality: 'The owner may need to balance business reserves, estimated taxes, family spending, retirement contributions, and investment outside the company.',
          familyLayer: 'The household may be proud of the business and still need more clarity about how much risk and responsibility it carries.',
          controlTension: 'They do not want to be sold to or talked down to; they want someone who can think with them plainly.',
          retirementOrExitLayer: 'Some owners are approaching succession or sale, but many need current structure before exit planning is the main conversation.',
          voiceNotes: 'Use rooted, respectful language. The state line is a real planning fact only when it changes the decision.',
        },
        qualityGate: {
          approvedForIndex: true,
          score: 8,
          uniqueLocalDecision: 'Bristol owner page focused on TN/VA sourcing, owner pay, tax timing, cash reserves, and household wealth.',
          specificFit: 'Independent Bristol and SWVA owners whose business success creates tax, cash-flow, retirement-plan, or family-wealth decisions.',
          specificNonFit: 'Owners looking for bookkeeping-only help or a one-size-fits-all state-line tax answer.',
          proofStandard: 'Uses owner-pattern depth, state-line facts, and local service context without named-employer targeting.',
          reviewNotes: ['First-cluster business-owner page', 'Respectful independent-owner voice required', 'No fee-only language'],
        },
      },
    },
    serviceOverrides: {
      'proactive-tax-planning': {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: "For many families, yes — Virginia's state income tax can add up to thousands per year depending on your income. But the decision involves property values, schools, commute, and long-term goals. We model the actual tax difference for your specific income so you can decide from the numbers and the life tradeoffs together.",
          },
          {
  ...
  'morristown': {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Keystone is quoted as a flat planning fee based on the complexity of the work. If ongoing advisory makes sense after the plan is built, that structure is explained separately before you decide whether to continue.",
      },
    ],
    scenario: {
  ...
  'knoxville': {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Talley Wealth combines financial planning with tax planning and tax preparation under one roof. Most advisors do not prepare tax returns, and most CPAs do not build financial plans. We are built to coordinate both sides of the conversation.",
      },
      {
