...
export const blogStrategyBySlug: Record<string, BlogStrategy> = {
  'phantom-checkbox-roth-conversions': {
    ...
    links: [
      ...
      { title: 'The Keystone Method', href: '/services/keystone-plan', description: 'The planning process that coordinates tax, investments, retirement, and estate decisions.' },
  ...
  'what-tax-planning-actually-looks-like': {
    ...
    links: [
      ...
      { title: 'The Keystone Method', href: '/services/keystone-plan', description: 'How tax decisions get coordinated with the rest of the plan.' },
  ...
  'what-changes-as-financial-independence-gets-closer': {
    ...
    links: [
      ...
      { title: 'The Keystone Method', href: '/services/keystone-plan', description: 'The planning engagement for connected decisions.' },
    ],
    cta: {
