...
export const cities: Record<string, CityData> = {
  'johnson-city': {
    ...
    metaDescription: 'Financial planning in Johnson City for retirement income, tax strategy, investments, and major financial transitions.',
  ...
  'tri-cities': {
    ...
    metaDescription: 'Financial planning across Johnson City, Bristol, Kingsport, and the Tri-Cities for taxes, investments, and retirement decisions.',
  ...
  'bristol': {
    ...
    metaDescription: 'Financial planning for Bristol, TN and Bristol, VA families coordinating cross-state taxes, retirement, and investments.',
  ...
  'sevierville': {
    ...
    heroImage: '/brands/talley-wealth/cities/sevierville-smoky-mountains.webp',
